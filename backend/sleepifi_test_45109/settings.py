"""
Django settings for sleepifi_test_45109 project.
...
ROOT_URLCONF = 'sleepifi_test_45109.urls'
...
WSGI_APPLICATION = 'sleepifi_test_45109.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "sleepifi_test_45109 API",
    "DESCRIPTION": "API documentation for sleepifi_test_45109 App",
    "VERSION": "v1",
}
